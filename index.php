                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="input-group mb-3" style="background-color:#003666; color:white">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" style="background-color:#003666; color:white" for="inputGroupSelect01">Selecione quantidade de pneus por veiculo</label>
                                </div>
                          ...
                          <div class="col-sm-12 col-md-6 col-lg-6">
                            <div class="input-group mb-3" style="background-color:#003666; color:white">
                                <div class="input-group-prepend">
                                    <label class="input-group-text" style="background-color:#003666; color:white" for="inputGroupSelect01">Selecione quantidade de veiculos</label>
                                </div>
                                <select class="custom-select" id="inputGroupSelect01">
